...
-- 
-- Host: localhost
-- Generation Time: Apr 07, 2014 at 07:17 AM
...
CREATE TABLE IF NOT EXISTS `requests` (
  `id` int(11) NOT NULL auto_increment COMMENT 'ID',
  `request_by_user` varchar(50) NOT NULL COMMENT 'Requested by',
  ...
  `user_accept_request` varchar(50) NOT NULL COMMENT 'Accepted by',
  `request_start_repair_date` datetime NOT NULL COMMENT 'Start repair date',
  `user_repair` varchar(50) NOT NULL COMMENT 'Repair by',
  ...
  `user_close` varchar(50) NOT NULL COMMENT 'Close job by',
  `request_answer` text NOT NULL COMMENT 'Cause symptoms',
...
INSERT INTO `requests` VALUES (1, 'Komsan_K', 111111, 11111, 'k.kamsamur@gmail.com', 6, 13, 212, 'เปิดเครื่องไม่ได้เลย', 'ทำไงดีีีีีีีีีีี', 'กกกกก', '2014-04-06 21:28:56', '2014-04-06 22:37:53', 'admin', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', 'wait', '');
INSERT INTO `requests` VALUES (2, 'Komsan_K', 111111, 11111, 'k.kamsamur@gmail.com', 6, 3, 395, 'เครื่องรีสตาร์ทเองบ่อยมาก', 'อธิบายไม่ถูก', '', '2014-04-07 00:11:52', '2014-04-07 01:11:52', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', 'wait', '');
...
INSERT INTO `users` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'webmaster@example.com', '9a24eff8c15a6a141ece27eb6947da0f', '2014-03-25 16:43:29', '2014-04-07 02:29:40', 1, 1);
...
INSERT INTO `users` VALUES (3, 'it_student_b6', 'f65c10ef2cf4fb089208c220296240a7', 'itstudent.trainee@wdc.com', 'a68e114ebb1a165db672404d5ac74fbd', '2014-04-01 16:28:03', '2014-04-07 02:21:04', 0, 1);
