...
class DeviceBrandController extends RController
{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('DeviceBrand');
	...
	{
		$model=DeviceBrand::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DeviceBrand $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='device-brand-form')
		{
