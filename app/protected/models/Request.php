...
class Request extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'request_by_user' => 'Request by | ชื่อผู้แจ้งซ่อม',
			'request_en' => 'En | หมายเลขพนักงาน',
			'request_ext' => 'Ext | เบอร์โทร',
			'request_email' => 'E-mail | อีเมล์',
			'location_id' => 'Location | สถานที่ทำงาน',
			'department_id' => 'Department | แผนก',
			'device_id' => 'Device | อุปกรณ์ที่ต้องการแจ้งซ่อม',
